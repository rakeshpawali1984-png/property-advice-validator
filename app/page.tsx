              ...
              {contextType === 'property' ? (
                ...
                !showAnalyzer ? (
                  <button
                    ...
                    className="flex w-full sm:w-auto sm:inline-flex items-center gap-2 text-sm font-medium text-blue-700 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-xl border border-blue-200 transition-all duration-200"
                  >
